...
[0014](../networking/0014-adguard-home-internal-dns-deferred.md)) — and a smart-home panel is more
...
`headscale-subnet-router` (see [0006](../storage/0006-rook-ceph-topology-and-local-path-interim.md))
